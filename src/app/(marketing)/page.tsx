...
export const metadata: Metadata = {
  ...
  description: `AI expense tracker for India on web and Google Play. Log "Zomato 450" in Hindi, Marathi, Hinglish & 22+ languages—voice, text, or receipt scan. Free: 7 AI chats/day. Download Android: ${PLAY_STORE_URL.replace("https://", "")}. Premium: unlimited AI & budgets. ${CURRENCIES.length}+ currencies.`,
